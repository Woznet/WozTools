...
FunctionsToExport = 'Add-EnvPath', 'Add-ISEText', 'Add-PSModulePath', 'Clone-GitRepo', 
               ...
               'Get-GitHubUserRepo', 'Get-PathFromClipboard', 
               'Get-StringFromSecureString', 'Invoke-Beep', 'Invoke-InDirectory', 
               'Invoke-psEdit', 'Invoke-WSLPath', 'Join-Url', 'New-DirandEnter', 
...
FileList = 'LICENSE', 'README.md', 'WozTools.psd1', 'WozTools.psm1', 
               'Lib\PForEach\PForEach.dll', 'Public\Add-EnvPath.ps1', 
               'Public\Add-ISEText.ps1', 'Public\Add-PSModulePath.ps1', 
               'Public\Clone-GitRepo.ps1', 'Public\Convertto-TitleCase.ps1', 
