...
TypesToProcess = 'Lib\Formatting\MyTypes.types.ps1xml'

# Format files (.ps1xml) to be loaded when importing this module
FormatsToProcess = 'Lib\Formatting\Show-LinkTarget.format.ps1xml'
...
'Join-Url','New-ANSIString','New-DirandEnter','New-Shortcut','Open-NotepadPlusPlus',
'Open-Script','Out-ISETab','Push-GitChanges','Remove-EnvPath','Save-ISEFile',
'Search-WinCatalog','Select-GitHubLanguage','Set-AutoLogin','Set-ConsoleSize',
'Set-ConsoleWindow','Set-MaxPartitionSize','Start-ConsoleCommand',
'Start-PSLogging','Test-IfAdmin','Test-Url','Get-HostEntry'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'v2.6.5 - had to remove the FileList part of the module manifest to get "Enable-FileSize" to work.  This probably has something to do with the ps1xml files that "Enable-FileSize" uses or something along those lines.'
