...
FunctionsToExport = 'Add-EnvPath', 'Add-ISEText', 'Add-PSModulePath', 'Clone-GitRepo', 
               ...
               'Get-FunctionCode', 'Get-GitHubUserRepo', 'Get-ItemFromClipboard', 
               'Get-PathFromClipboard', 'Get-StringFromSecureString', 'Invoke-Beep', 
               'Invoke-InDirectory', 'Invoke-psEdit', 'Invoke-WSLPath', 'Join-Url', 
               'New-DirandEnter', 'New-Shortcut', 'Open-Script', 'Out-ISETab', 
               'Push-GitChanges', 'Remove-EnvPath', 'Save-ISEFile', 
               'Search-WinCatalog', 'Select-GitHubLanguage', 'Set-AutoLogin', 
               'Set-ConsoleSize', 'Set-ConsoleWindow', 'Set-MaxPartitionSize', 
               'Start-ConsoleCommand', 'Start-PSLogging', 'Sync-Profile', 
               'Test-IfAdmin'
...
FileList = 'LICENSE', 'README.md', 'WozTools.psd1', 'WozTools.psm1', 
               ...
               'Public\Get-GitHubUserRepo.ps1', 'Public\Get-ItemFromClipboard.ps1', 
               'Public\Get-PathFromClipboard.ps1', 
               ...
               'Lib\PForEach\PForEach.dll', 'Lib\AlphaFS\Net452\AlphaFS.dll', 
