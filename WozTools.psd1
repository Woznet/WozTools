...
'Get-EnumerateFiles','Get-EnvPath','Get-FunctionCode','Get-GitHubUserRepos',
'Get-HostEntry','Get-ItemFromClipboard','Get-RedirectedUrl','Get-RelativePath',
'Get-StringFromSecureString','Invoke-Beep','Invoke-GitClone','Invoke-InDirectory',
'Invoke-psEdit','Invoke-ReArmLicense','Join-Url','New-ANSIString',
'New-DirandEnter','New-Shortcut','Open-NotepadPlusPlus','Open-Script',
'Out-ISETab','Push-GitChanges','Remove-EnvPath','Save-ISEFile',
