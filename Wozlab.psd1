#
# Module manifest for module 'Wozlab'
#
# Generated by: Woz
#
...
FunctionsToExport = 'Add-EnvPath', 'Beep', 'Copy-GitRepo', 'Download-GitUser', 
               ...
               'Get-DotNetFrameworkVersion', 'Get-EvPath', 'Get-Functions', 
               'Get-PartitionInfo', 'Get-PipelineInfo', 'Invoke-InDirectory',
               'Invoke-WebDownload', 'List-SpecialFolders', 'Max-PartitionSize',
               'New-DynamicParam', 'New-Shortut', 'Open-NPP', 'Open-Script', 'Out-ISETab',
               'Remove-EnvPath', 'Restart-Process', 'Search-WinCatalog', 'Select-All',
               'Set-AutoLogin', 'Show-Cmdlet', 'Shutdown-ESXI', 'Source-Directory', 
